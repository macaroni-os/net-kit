...
SRC_URI="
https://api.github.com/repos/gogs/gogs/tarball/v0.14.1 -> gogs-0.14.1-f5c8030.tar.gz
mirror://macaroni/gogs-0.14.1-mark-go-bundle-f5c8030.tar.xz -> gogs-0.14.1-mark-go-bundle-f5c8030.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
