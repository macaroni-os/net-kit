...
SRC_URI="
https://api.github.com/repos/gogs/gogs/tarball/v0.13.3 -> gogs-0.13.3-5084b4a.tar.gz
mirror://macaroni/gogs-0.13.3-mark-go-bundle-5084b4a.tar.xz -> gogs-0.13.3-mark-go-bundle-5084b4a.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
