...
SRC_URI="
https://codeberg.org/forgejo/forgejo/archive/v15.0.5.tar.gz -> forgejo-15.0.5.tar.gz
mirror://macaroni/forgejo-15.0.5-mark-go-bundle.tar.xz -> forgejo-15.0.5-mark-go-bundle.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
