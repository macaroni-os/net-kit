...
SRC_URI="
https://codeberg.org/forgejo/forgejo/archive/v12.0.3.tar.gz -> forgejo-12.0.3.tar.gz
mirror://macaroni/forgejo-12.0.3-mark-go-bundle.tar.xz -> forgejo-12.0.3-mark-go-bundle.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
