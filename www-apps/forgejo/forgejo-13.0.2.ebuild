...
SRC_URI="
https://codeberg.org/forgejo/forgejo/archive/v13.0.2.tar.gz -> forgejo-13.0.2.tar.gz
mirror://macaroni/forgejo-13.0.2-mark-go-bundle.tar.xz -> forgejo-13.0.2-mark-go-bundle.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
