...
SRC_URI="
https://codeberg.org/forgejo/forgejo/archive/v15.0.8.tar.gz -> forgejo-15.0.8.tar.gz
mirror://macaroni/forgejo-15.0.8-mark-go-bundle.tar.xz -> forgejo-15.0.8-mark-go-bundle.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
