...
SRC_URI="
https://codeberg.org/forgejo/forgejo/archive/v14.0.1.tar.gz -> forgejo-14.0.1.tar.gz
mirror://macaroni/forgejo-14.0.1-mark-go-bundle.tar.xz -> forgejo-14.0.1-mark-go-bundle.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
