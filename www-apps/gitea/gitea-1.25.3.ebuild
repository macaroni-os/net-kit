...
SRC_URI="
https://api.github.com/repos/go-gitea/gitea/tarball/v1.25.3 -> gitea-1.25.3-9a7cfd8.tar.gz
mirror://macaroni/gitea-1.25.3-mark-go-bundle-9a7cfd8.tar.xz -> gitea-1.25.3-mark-go-bundle-9a7cfd8.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
