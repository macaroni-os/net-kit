...
SRC_URI="
https://api.github.com/repos/go-gitea/gitea/tarball/v1.24.5 -> gitea-1.24.5-136ec9e.tar.gz
mirror://macaroni/gitea-1.24.5-mark-go-bundle-136ec9e.tar.xz -> gitea-1.24.5-mark-go-bundle-136ec9e.tar.xz"
SLOT="0"
KEYWORDS="*"
DOCS=(
