...
SRC_URI="
https://api.github.com/repos/go-gitea/gitea/tarball/v1.27.3 -> gitea-1.27.3-146cc3e.tar.gz
mirror://macaroni/gitea-1.27.3-mark-go-bundle-146cc3e.tar.xz -> gitea-1.27.3-mark-go-bundle-146cc3e.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
