...
SRC_URI="
https://api.github.com/repos/go-gitea/gitea/tarball/v1.26.4 -> gitea-1.26.4-95ba37d.tar.gz
mirror://macaroni/gitea-1.26.4-mark-go-bundle-95ba37d.tar.xz -> gitea-1.26.4-mark-go-bundle-95ba37d.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
