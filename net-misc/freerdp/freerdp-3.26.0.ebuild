...
SRC_URI="https://api.github.com/repos/FreeRDP/FreeRDP/tarball/3.26.0 -> freerdp-3.26.0-3f6d7cb.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="alsa cpu_flags_arm_neon cups debug doc +ffmpeg fuse gstreamer jpeg kerberos
