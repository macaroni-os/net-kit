...
SRC_URI="https://gitlab.freedesktop.org/NetworkManager/NetworkManager/-/archive/1.56.0/networkmanager-1.56.0.tar.bz2 -> networkmanager-1.56.0.tar.bz2"
...
"
S="${WORKDIR}/NetworkManager-1.56.0"
post_src_unpack() {
	mv NetworkManager-* "${S}"
}
pkg_setup() {
