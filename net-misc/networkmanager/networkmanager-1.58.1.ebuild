...
SRC_URI="https://gitlab.freedesktop.org/NetworkManager/NetworkManager/-/archive/1.58.1/networkmanager-1.58.1.tar.bz2 -> networkmanager-1.58.1.tar.bz2"
...
"
S="${WORKDIR}/NetworkManager-1.58.1"
post_src_unpack() {
	mv NetworkManager-* "${S}"
}
pkg_setup() {
