...
SRC_URI="
https://api.github.com/repos/pgsty/minio/tarball/RELEASE.2026-08-04T00-00-00Z -> minio-2026.08.04-d88f46c.tar.gz
mirror://macaroni/minio-2026.08.04-mark-go-bundle-d88f46c.tar.xz -> minio-2026.08.04-mark-go-bundle-d88f46c.tar.xz"
LICENSE="AGPL-3.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_compile() {
	...
	local minio_ldflags=(
	        ...
	        "-X github.com/minio/minio/cmd.CommitID=d88f46ccee345a9c2fabe2d221d9a9e56bc11aec"
	        "-X github.com/minio/minio/cmd.ShortCommitID=d88f46c"
	)
	CGO_ENABLED=0 \
