...
SRC_URI="
https://api.github.com/repos/pgsty/silo/tarball/RELEASE.2026-08-06T00-00-00Z -> minio-2026.08.06-3be10fc.tar.gz
mirror://macaroni/minio-2026.08.06-mark-go-bundle-3be10fc.tar.xz -> minio-2026.08.06-mark-go-bundle-3be10fc.tar.xz"
LICENSE="AGPL-3.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_compile() {
	...
	local minio_ldflags=(
	        ...
	        "-X github.com/minio/minio/cmd.CommitID=3be10fcc1a44f6620ded0bd303461f9d688cca23"
	        "-X github.com/minio/minio/cmd.ShortCommitID=3be10fc"
	)
	CGO_ENABLED=0 \
