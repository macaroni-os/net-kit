...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v5.10.7/tdesktop-5.10.7-full.tar.gz -> tdesktop-5.10.7-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v5.10.7/tsetup.5.10.7.tar.xz -> tsetup.5.10.7.tar.xz"
