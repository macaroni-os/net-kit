...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v5.6.0/tdesktop-5.6.0-full.tar.gz -> tdesktop-5.6.0-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v5.6.0/tsetup.5.6.0.tar.xz -> tsetup.5.6.0.tar.xz"
