...
SRC_URI="amd64? (
  https://github.com/mattermost/desktop/releases/download/v5.12.0/mattermost-desktop-5.12.0-linux-x64.tar.gz -> mattermost-desktop-5.12.0-linux-x64.tar.gz
)
arm64? (
  https://github.com/mattermost/desktop/releases/download/v5.12.0/mattermost-desktop-5.12.0-linux-arm64.tar.gz -> mattermost-desktop-5.12.0-linux-arm64.tar.gz
)
"
